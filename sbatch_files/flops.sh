...
#SBATCH -J flops                   # job name, don't use spaces, keep it short
...
#SBATCH --output=/home/s2435462/HRC/out/log/new/flops_%j.log      # Standard output and error log
#SBATCH --error=/home/s2435462/HRC/out/err/new/flops_%j.err                # if yoou want the errors logged seperately
...
python -u ../flops.py --config_file ../config_flops.yml

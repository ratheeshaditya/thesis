...
#SBATCH -J visualize                   # job name, don't use spaces, keep it short
...
#SBATCH --output=/home/s2435462/HRC/out/log/new/visualize_%j.log      # Standard output and error log
#SBATCH --error=/home/s2435462/HRC/out/err/new/visualize_%j.err                # if yoou want the errors logged seperately
...
python -u ../visualize_results.py --config_file ../config_visualize.yml
